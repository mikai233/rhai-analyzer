...
use crate::infer::calls::{effective_call_argument_types, expected_call_signature};
use crate::types::{
...
impl DatabaseSnapshot {
    ...
    pub fn call_argument_count_at(&self, file_id: FileId, offset: TextSize) -> Option<usize> {
